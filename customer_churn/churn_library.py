# library doc string
'''
This library contains all functions required to detect customer churn in
dataset saved in `data/` directory, as well as performing EDA and generating
a series of reports and charts to evaluate the trained models.
'''
# import libraries
...
def encoder_helper(df, category_lst, response):
    ...
    for category in category_lst:
        ...
        l = [groups.loc[val] for val in df[category]]

        df[f'{category}_{response}'] = l
...
def perform_feature_engineering(df, response):
    ...
    y = df['Churn']
    X = encoder_helper(df, cat_columns, response)[keep_cols]
...
def train_models(X_train, X_test, y_train, y_test):
    ...
    # create report for both sets of models
